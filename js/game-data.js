...
// --- 平衡調整：不屈天賦改為每級減少 1% 受到的傷害 ---
{ id: "defense3", name: "不屈", maxLevel: 5, cost: 2, description: "受到攻擊時，每級減少 1% 受到的傷害。", applyEffect: (level) => { player.percentDamageReduction = (player.percentDamageReduction || 0) + 0.01; }, requires: { id: "defense2", level: 1 } },
